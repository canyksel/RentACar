...
public class ModelConfiguration : IEntityTypeConfiguration<Model>
{
    public void Configure(EntityTypeBuilder<Model> builder)
    {
        ...
        Model[] modelEntitySeeds = {
            new(id: 1, brandId: 1, fuelId:1, name: "Series 4", dailyPrice: 1500, imageUrl: ""),
            new(id: 2,brandId: 1,fuelId: 2, name: "Series 3",dailyPrice: 1250,imageUrl: ""),
            new(id: 3,brandId: 2,fuelId: 3, name: "A180",dailyPrice: 1100,imageUrl: "")
        };
